        ...
        <div class="card o-hidden border-0 shadow-lg my-5"> 
            <!-- Nested Row within Card Body -->
                <div class="p-5">
                      ...
                      <form class="user" id="siswa" method="POST" action="<?= base_url('loginsiswa') ?>">
                        <?= csrf_field() ?>

                          <div class="form-group">
                            <input id="nisn" type="text" class="form-control" name="nisn" tabindex="1" value="<?= set_value('nisn', '', true) ?>" placeholder="NISN...">
                          ...
                          <div class="form-group text-right">
                            ...
                            <a href="<?= base_url('login') ?>" class="btn btn-info btn-block">
                              <i class="fas fa-user fa-fw"></i> Login sebagai admin
                            </a>
                          </div>
                          </hr>
                      </form>
